...
| [purchases](purchases/spec.md) | M3 | Suppliers, per-supplier cost history, purchases, purchase orders from the reorder suggestion, cancellation, and the stale-cost warning with its apply-cost action on a confirmed line |
